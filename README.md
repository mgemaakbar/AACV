...
There are 3 python notebooks: ```detectron2.ipynb```, ```detr_with_detectron2.ipynb```, ```yolo.ipynb```. All of them expects you to import the ```data_preparation.py``` which is asssumed to be in ```/content/```.
